...
/**
 * This class makes the graphical user interface of the calculator. 
 * It includes all the buttons, textArea and a bunch of action listeners.
 * to run the program this file needs to be executed. 
 */
public class GraphicalUserInterface extends JFrame {
	...
	public GraphicalUserInterface() {
		/*
		 * Create frame Create panels Create all buttons Add buttons to panels
		 * Add panels to mainpanel Add mainpanel to frame Create calculator
		 * 
		 */
		...
		JButton button_rat = new JButton("RAT");
		JButton button_fixed = new JButton("FIXED");
		JButton button_float = new JButton("FLOAT");
		JButton button_semiL = new JButton("(");
		JButton button_semiR = new JButton(")");
		...
		JButton button_next = new JButton("NEXT"); // in command.java this is
													// equal to (op n) where n
													// is a number. (op 5 would
													// load 5 on operand 1.)
		...
		button_0.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (resultIsPressed && !operatorStatus) {
					textArea.setText("");
					calc.clearStacks();
				}
				if (operatorStatus) {
		...
		button_div.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					calc.addOperandToStack(calc.createOperand(textArea.getText())); // 0
																					// =
																					// 5;
				} catch (FormatException e1) {
					e1.printStackTrace();
		...
		button_result.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					calc.addOperandToStack(calc.createOperand(textArea.getText())); // 1
																					// =
																					// 10
				} catch (FormatException e1) {
					e1.printStackTrace();
	...
	//method to set text in the textArea
	public void setText(String text) {
		this.textArea.setText(text);
	}
	
	//method to add lines to the textArea 
